...
@Component({
  ...
  template: `
    <div class="admin-container">
            ...
            <form [formGroup]="adminForm" (ngSubmit)="addAdmin()" class="admin-form">
              <div class="form-row">
                ...
                <div class="form-field">
                  ...
                  />
                  @if (adminForm.get('displayName')?.invalid &&
                  adminForm.get('displayName')?.touched) {
                  <div class="error-message">Display name is required</div>
                  }
                </div>

                <button type="submit" class="add-btn" [disabled]="adminForm.invalid || isAdding()">
      ...
      <div class="remove-modal-overlay" (click)="cancelRemoveAdmin()">
        <div class="remove-modal" (click)="$event.stopPropagation()">
          ...
          <div class="modal-actions">
            <button type="button" (click)="cancelRemoveAdmin()" class="cancel-btn">Cancel</button>
            <button type="button" (click)="removeAdmin()" class="remove-btn">Remove Admin</button>
          </div>
        </div>
      </div>
      } }
